...
<div>
  <div class="direction">
      <label class="switch" title="select-direction"> select direction
        <input type="checkbox" v-model="model" title="select direction">
        <label title="select direction" :key="componentKey" :data-on="directions[1]" :data-off="directions[0]" class="switch-inner">:</label>
      </label>
      </div>
</div>
  </template>
